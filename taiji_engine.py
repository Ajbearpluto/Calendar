...
class TaijiOmniverseCalendar:
    ...
    def _init_static_databases(self):
        ...
        self.fortune_fusion = [
            ...
            {"text": "天王星帶來突發變動，原本的完美計畫隨時可能被一場大雨打亂。", "prop": "一雙踩進水坑的白球鞋", "music_text": "🎶 史詩氛圍 Epic Ambient - 迎接未知挑戰", "yt_id": "1UEmIfR5ZUM"},
            {"text": "木星能量飽滿，今天是發揮靈感與整理思緒的絕佳時機。", "prop": "一杯冒著熱氣的黑咖啡", "music_text": "🎶 原聲吉他 Acoustic Folk - 專注與純粹", "yt_id": "MCkTebktHVc"}
        ]
        self.themes_data = {
