...
class TaijiOmniverseCalendar:
    ...
    def export_to_html(self):
        ...
        <head>
            ...
            <title>TAIJI V36 Full Edition</title>
        ...
        <body>
            ...
            <script>
                ...
                function applyDateChange() {{
                    ...
                    }} catch (e) {{ document.getElementById('display-lunar').innerText = "農曆查無資料"; }}
                    randomizeAll();
                }}
                ...
                window.onload = function() {{ setTimeout(applyDateChange, 200); }};
