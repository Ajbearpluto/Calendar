...
class TaijiOmniverseCalendar:
    ...
    def _init_static_databases(self):
        ...
        # 🎵 修復 YouTube ID，確保允許外部網站嵌入播放
        self.fortune_fusion = [
            {"text": "星象顯示有破財危機，請立刻關閉所有購物APP的推播通知。", "prop": "一張正在燃燒的信用卡", "music_text": "🎶 迷幻爵士 Jazz Hop - 適合沉澱焦慮", "yt_id": "NEKzFqGZ-g0"}, 
            {"text": "水星逆行引發通訊危機，今日請再三確認訊息是否發錯群組。", "prop": "一支停在尷尬聊天室畫面的手機", "music_text": "🎶 輕快 Lofi Beats - 保持心情平靜", "yt_id": "5yx6BWlEVcU"}, 
            {"text": "天王星帶來突發變動，原本的完美計畫隨時可能被一場大雨打亂。", "prop": "一雙踩進水坑的白球鞋", "music_text": "🎶 史詩氛圍 Epic Ambient - 迎接未知挑戰", "yt_id": "RkTiZ3X11bQ"},
            {"text": "木星能量飽滿，今天是發揮靈感與整理思緒的絕佳時機。", "prop": "一杯冒著熱氣的黑咖啡", "music_text": "🎶 原聲吉他 Acoustic Folk - 專注與純粹", "yt_id": "FjHGZj2Ijvw"}
        ]
        self.themes_data = {
    ...
    def generate_quotes_via_llm(self, forum_titles):
        ...
        try:
            ...
            sys_log_msg = f"V40 視覺解禁完成，鎖定模型: {working_model}"
